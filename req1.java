...
public class req1 extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	     ...
	     * @param m 
	     */
	    public req1(String m) {
	        initComponents();
	        this.setLocation(500, 200);
	      	this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
	        DefaultTableModel model=new DefaultTableModel();
	        model.addColumn("nom_etu");
	        model.addColumn("prenom_etu ");
	     ...
	     String note=   m ;
	       /*model.addColumn("Poids");
	        ...
	        TABLEPRO.setModel(model);
	  	   String requeteListe = " select etudiant.matricule_etu, nom_etu , prenom_etu , unite.libelle  from etudiant,unite,etudiantunite  where  etudiantunite.matricule_etu=etudiant.matricule_etu  and etudiantunite.code_unite = unite.code_unite and etudiantunite.note_examen='"+ m +"'  ";
	        try{
	            stListe=maconnexion.etablirconnection().createStatement();
	            ResultSet resultat =stListe.executeQuery(requeteListe);
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("nom_etu"),resultat.getString("prenom_etu"),resultat.getString("libelle")});
	            }
