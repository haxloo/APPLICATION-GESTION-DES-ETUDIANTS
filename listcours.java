...
public class listcours extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	    ...
	    public listcours() {
	        ...
	        model.addColumn("Id section ");
	        model.addColumn("Nom section");
	       ...
	       /* model.addColumn("Date_Nai");
	        ...
	        String requeteListe="select * from section";
	        try{
	            stListe=maconnexion.etablirconnection().createStatement();
	            ResultSet resultat =stListe.executeQuery(requeteListe);
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("id_section"),resultat.getString("nom_section"),resultat.getString("niveau"),resultat.getString("specialite")});
	            }
	    ...
	    private void initComponents() {
	        ...
	        jLabel1.setText("LISTE DES Section ");
