...
public class ges_prof extends JFrame implements ActionListener {
	...
	{ 
     ...
     p.setLayout(null);
     JLabel lbnum=new JLabel("Matricule");
     JLabel lbnom=new JLabel("Nom");
     JLabel lbdt=new JLabel("Prenom");  
     JLabel lbsal=new JLabel("age");
 ...
 //suppression
		...
		String query="DELETE FROM enseignant WHERE matricule_ens='"+n+"'";
		...
		if(e.getSource()==btModif)
		{
			...
			String query="UPDATE  enseignant  SET nom_ens='"+p+"', prenom_ens='"+pr+"',age='"+d+"' where  matricule_ens="+n+"";
   ...
   String query="SELECT * FROM enseignant  WHERE matricule_ens='"+n+"'";
		...
		try {
			...
			if(rst.next())
			{   txtnum.setText(rst.getString("matricule_ens"));
				txtnom.setText(rst.getString("nom_ens"));
				txtdat.setText(rst.getString("prenom_ens"));
				txtsal.setText(rst.getString("age"));
