...
public class listEleve extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	    ...
	    public listEleve() {
	        ...
	        model.addColumn("Matricule etudiant");
	        model.addColumn("Nom ");
	        model.addColumn("Prenom");
	        model.addColumn("Date naiss");
	        model.addColumn("Adresse");
	        model.addColumn("Section");
	   
	       
	        TABLEPRO.setModel(model);
	        String requeteListe = "select  * from etudiant ";
	        ...
	        try{
	            ...
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("matricule_etu"), resultat.getString("nom_etu"),resultat.getString("prenom_etu"),resultat.getString("date_naissance"),resultat.getString("adresse"),resultat.getString("id_section")});
	            }
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(listEleve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
