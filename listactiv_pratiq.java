...
public class listactiv_pratiq extends javax.swing.JFrame{/*
	...
	connection maconnexion = new connection();
	     ...
	     */
	    public listactiv_pratiq() {
	    	 this.setLocation(500, 200);
	    	  	this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
	        initComponents();
	        DefaultTableModel model=new DefaultTableModel();
	        model.addColumn("Code unite ");
	        model.addColumn("Libelle");
	        model.addColumn("Nbr heures");
	        model.addColumn("Matricule ens");
	       
	        TABLEPRO.setModel(model);
	        String requeteListe="select * from unite";
	        try{
	            stListe=maconnexion.etablirconnection().createStatement();
	            ResultSet resultat =stListe.executeQuery(requeteListe);
	            while(resultat.next()){
	                model.addRow(new Object []{ resultat.getString("code_unite"),resultat.getString("libelle"),resultat.getString("nbr_heures"),resultat.getString("matricule_ens")});
	            }
	    ...
	    private void initComponents() {
	        ...
	        jLabel1.setText("LISTE DES Unités");
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(listactiv_pratiq.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	      ...
	      /* java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	               new listactiv_pratiq().setVisible(true);
	            }
	        });*/
	    }
