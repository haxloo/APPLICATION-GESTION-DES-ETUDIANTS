...
public class Fen_ajout_cours extends JFrame implements ActionListener {
	...
	{ 
     ...
     p.setLayout(null);
     JLabel lbnum=new JLabel("Id Section");
     JLabel lbnom=new JLabel("Nom Section");
     JLabel lbnbr=new JLabel("Niveau");
     JLabel lbann=new JLabel("Specialite");
     JLabel lbT=new JLabel("INFORMATION Section");
...
@Override
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==bten)
		{
			...
			String query="Insert into section values('"+nu+"','"+n+"','"+p+"','"+d+"')";
